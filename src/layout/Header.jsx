...
const Header = () => {
  ...
  useEffect(() => {
    ...
    if (hash) {
      scroll.scrollTo(hash, {smooth: true, duration: 500});
    }
  }, [location]);
  ...
  return (
    <header className="bg-white shadow-md">
      <div className="mx-auto w-full flex items-center justify-between py-4 px-12 md:px-14 lg:px-20 lg:py-6">
        <a className="z-50" href="/uiux-portfolio">
            <svg className="w-28 h-auto md:w-36 lg:w-40 transition-colors duration-500 hover:text-[#ffc26f]" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1642 774">
          ...
          <div className="hidden md:flex items-center justify-between space-x-8">
            <RouterLink
              ...
              className="cursor-pointer text-black font-exo font-bold text-lg tracking-wide 
                    transition-colors duration-500 hover:text-[#ffc26f] lg:text-2xl"
            >ABOUT</RouterLink> 
            <RouterLink
            ...
            <RouterLink
              ...
              className="cursor-pointer text-black font-exo font-bold text-lg tracking-wide 
                    transition-colors duration-500 hover:text-[#ffc26f] lg:text-2xl"
            >SERVICES</RouterLink>
            <a href="mailto123@gmail.com"
            className="bg-[#ffc26f] text-white font-exo font-bold text-lg tracking-wide rounded-full py-3 px-4 
            border-2 border-[#ffc26f] transition-all duration-700 hover:bg-white hover:text-[#ffc26f] lg:text-2xl"
            >CONTACT ME</a>
          </div>
        </nav>
